...
def Set_time_RTC():
    ...
    secondes_alarm = int(secondes)
    print("Secondes alarme : {0}".format(secondes_alarm))
    secondes_alarm = secondes_alarm+2
    print("Secondes alarme : {0}\n\n".format(secondes_alarm))
    secondes_alarm = str(secondes_alarm)
    print("Secondes alarme : {0}\n\n".format(secondes_alarm))
