...
#bus.read_i2c_block_data(SLAVE_ADDRESS, CONTROL_1, 4)
#time.sleep(1)
#bus.read_i2c_block_data(SLAVE_ADDRESS, CONTROL_1, 4)
#time.sleep(1)

#print(bus.read_i2c_block_data(SLAVE_ADDRESS, CONTROL_1, 4))

while True: 
	print(bus.read_i2c_block_data(SLAVE_ADDRESS, CONTROL_1, 5))
	time.sleep(1)
