...
try: 
    ...
    secondes_rpi, minutes_rpi, heures_rpi = int(secondes_rpi, minutes_rpi, heures_rpi)
    secondes_RTC, minutes_RTC, heures_RTC = int(secondes_RTC, minutes_RTC, heures_RTC)
